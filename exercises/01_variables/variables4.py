...
# cost_bar = '#' * (cost // revenue) * 25 # the // floor function rounds down and drops the float
cost_bar = '#' * int((cost / revenue) * 25) # dividing always returns a float a that can cause errors
